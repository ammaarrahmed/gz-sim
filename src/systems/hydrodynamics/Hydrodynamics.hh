...
namespace systems
{
  ...
  ///   * `<namespace>` - This allows the robot to have an individual
  ///     namespace
  ...
  ///   * `<disable_coriolis>` - Disable Coriolis force [Boolean, Default:
  ///     false]
  ///   * `<disable_added_mass>` - Disable Added Mass [Boolean, Default:
  ///     false].
